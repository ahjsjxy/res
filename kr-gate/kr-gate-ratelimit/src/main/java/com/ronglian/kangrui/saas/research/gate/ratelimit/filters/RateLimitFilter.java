...
package com.ronglian.kangrui.saas.research.gate.ratelimit.filters;
...
import com.ronglian.kangrui.saas.research.gate.ratelimit.config.properties.RateLimitProperties.Policy;
import com.ronglian.kangrui.saas.research.gate.ratelimit.config.properties.RateLimitProperties.Policy.Type;
    ...
    private String key(final HttpServletRequest request, final List<Type> types) {
        ...
        if (!types.isEmpty()) {
            ...
            if (types.contains(Type.USER)) {
                // 这里从Auth获取 header->token->username
